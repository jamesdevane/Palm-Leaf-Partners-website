...
const translations = {
  ...
  'mboka.melissa.domain':  { en: 'Law · The Justiciar', fr: 'Loi · La Justicière' },
  'mboka.melissa.archetype': { en: '"Drafts the charter. Signs it. Defends it."', fr: '« Rédige la charte. La signe. La défend. »' },
